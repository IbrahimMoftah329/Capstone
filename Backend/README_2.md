## How to run/setup the projects Backend server

Follow these steps to set up and run the projects backend server and contact admin to ensure you aquire the env file!


### 1. Clone the Repository

Before we start make sure you have cloned the repo! Clone the repo using either the HTML or SSH link:
