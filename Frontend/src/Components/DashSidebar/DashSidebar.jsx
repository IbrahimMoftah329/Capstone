...
const DashSidebar = () => {
  const items = [
    ...
    { label: 'Favorites', icon: <span className="sidebar-icon"><IoIosHeart /></span>, link: '/dashboard/favorite' },
    { label: 'Profile', icon: <span className="sidebar-icon"><BsSuitDiamondFill /></span>, link: '/dashboard/profile' },
